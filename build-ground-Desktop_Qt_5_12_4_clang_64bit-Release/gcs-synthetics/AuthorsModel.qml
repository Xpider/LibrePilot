...
ListModel {
    ...
    ListElement { name: "Rafael Bachmann" }
    ListElement { name: "Werner Backes" }
    ListElement { name: "Jose Barros" }
    ListElement { name: "Alex Beck" }
    ListElement { name: "Roy Bekken" }
    ListElement { name: "Andre Bernet" }
    ListElement { name: "Mikael Blomqvist" }
    ListElement { name: "Pete Boehl" }
    ListElement { name: "Berkely Brown" }
    ListElement { name: "Joel Brueziere" }
    ListElement { name: "Samuel Brugger" }
    ListElement { name: "Thierry Bugeat" }
    ListElement { name: "Glenn Campigli" }
    ListElement { name: "David Carlson" }
    ListElement { name: "Mike Carr" }
    ListElement { name: "Stefan Cenkov" }
    ListElement { name: "Andrés Chavarría Krauser" }
    ListElement { name: "Cosimo Corrado" }
    ListElement { name: "James Cotton" }
    ListElement { name: "Kalyn Doerr" }
    ListElement { name: "Steve Doll" }
    ListElement { name: "James Duley" }
    ListElement { name: "Heikko Ellermaa" }
    ListElement { name: "Piotr Esden-Tempski" }
    ListElement { name: "Steve Evans" }
    ListElement { name: "Peter Farnworth" }
    ListElement { name: "Ed Faulkner" }
    ListElement { name: "Andrew Finegan" }
    ListElement { name: "Kevin Finisterre" }
    ListElement { name: "Richard Flay" }
    ListElement { name: "Darren Furniss" }
    ListElement { name: "Olivier Gasté" }
    ListElement { name: "Cliff Geerdes" }
    ListElement { name: "Frederic Goddeeris" }
    ListElement { name: "Daniel Godin" }
    ListElement { name: "Anthony Gomes" }
    ListElement { name: "Rodney Grainger" }
    ...
    ListElement { name: "Harold Hankins" }
    ListElement { name: "Joe Hlebasko" }
    ListElement { name: "Andy Honecker" }
    ListElement { name: "Patrick Huebner" }
    ListElement { name: "Ryan Hunt" }
    ListElement { name: "Mark James" }
    ListElement { name: "Paul Jewell" }
    ListElement { name: "Michael Johnston" }
    ListElement { name: "Mateusz Kaduk" }
    ListElement { name: "Stefan Karlsson" }
    ListElement { name: "Ricky King" }
    ListElement { name: "Thorsten Klose" }
    ListElement { name: "Karl Knutsson" }
    ListElement { name: "Daniël Koek" }
    ListElement { name: "Sami Korhonen" }
    ListElement { name: "Hallvard Kristiansen" }
    ListElement { name: "Alan Krum" }
    ListElement { name: "Mike Labranche" }
    ListElement { name: "Edouard Lafargue" }
    ListElement { name: "Laurent Lalanne" }
    ListElement { name: "Fredrik Larsson" }
    ListElement { name: "Xavier Lecluse" }
    ListElement { name: "Richard Von Lehe" }
    ListElement { name: "Pablo Lema" }
    ListElement { name: "Julian Lilov" }
    ListElement { name: "Matt Lipski" }
    ListElement { name: "David Llama" }
    ListElement { name: "Jasper Van Loenen" }
    ListElement { name: "Fernando Lopez Jr." }
    ListElement { name: "Ákos Máté" }
    ListElement { name: "Ben Matthews" }
    ...
    ListElement { name: "Karsten Telling Nielsen" }
    ListElement { name: "Jan Nijs" }
    ListElement { name: "Ken Northup" }
    ListElement { name: "Craig Nuttall" }
    ListElement { name: "Bertrand Oresve" }
    ListElement { name: "Pashalis Padeleris" }
    ListElement { name: "Angus Peart" }
    ListElement { name: "Pablo Francisco Pérez Hidalgo" }
    ListElement { name: "John Pike" }
    ListElement { name: "Jorge Pombo Marcos" }
    ...
    ListElement { name: "Jonathan Rodgers" }
    ListElement { name: "Mathieu Rondonneau" }
    ListElement { name: "Jörg-D Rothfuchs" }
    ...
    ListElement { name: "Michael Schwingen" }
    ...
    ListElement { name: "Sam Wang" }
    ListElement { name: "Tianhe Wang" }
    ...
    ListElement { name: "Vladimir Zidar" }
}
