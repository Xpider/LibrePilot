...
#include "../../../../../../../ground/gcs/src/plugins/serialconnection/serialpluginoptionspage.h"
...
QT_MOC_LITERAL(2, 44, 0) // ""
    ...
    "SerialPluginOptionsPage\0availableDevChanged\0"
    ""
};
...
void SerialPluginOptionsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SerialPluginOptionsPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SerialPluginOptionsPage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPluginOptionsPage::availableDevChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialPluginOptionsPage::availableDevChanged()
{
