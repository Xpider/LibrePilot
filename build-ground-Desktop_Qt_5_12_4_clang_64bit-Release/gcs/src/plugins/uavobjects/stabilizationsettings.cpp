...
StabilizationSettings::StabilizationSettings(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    QStringList ForceRollPitchDuringYawTransitionElemNames;
    ForceRollPitchDuringYawTransitionElemNames << "0";
    QStringList ForceRollPitchDuringYawTransitionEnumOptions;
    ForceRollPitchDuringYawTransitionEnumOptions << "False" << "True";
    fields.append(new UAVObjectField("ForceRollPitchDuringYawTransition", tr(""), "", UAVObjectField::ENUM, ForceRollPitchDuringYawTransitionElemNames, ForceRollPitchDuringYawTransitionEnumOptions, ""));
...
void StabilizationSettings::setDefaultFieldValues()
{
    ...
    // ForceRollPitchDuringYawTransition
    data_.ForceRollPitchDuringYawTransition = 1;
...
void StabilizationSettings::emitNotifications()
{
    ...
    emit forceRollPitchDuringYawTransitionChanged(forceRollPitchDuringYawTransition());
    /*DEPRECATED*/ emit ForceRollPitchDuringYawTransitionChanged(getForceRollPitchDuringYawTransition());
...
void StabilizationSettings::registerQMLTypes() {
    ...
    qmlRegisterType<StabilizationSettings_ForceRollPitchDuringYawTransition>("UAVTalk.StabilizationSettings", 1, 0, "ForceRollPitchDuringYawTransition");
...
StabilizationSettings_ForceRollPitchDuringYawTransition::Enum StabilizationSettings::forceRollPitchDuringYawTransition() const
{
   QMutexLocker locker(mutex);
   return static_cast<StabilizationSettings_ForceRollPitchDuringYawTransition::Enum>(data_.ForceRollPitchDuringYawTransition);
}
void StabilizationSettings::setForceRollPitchDuringYawTransition(const StabilizationSettings_ForceRollPitchDuringYawTransition::Enum value)
{
   mutex->lock();
   bool changed = (data_.ForceRollPitchDuringYawTransition != static_cast<quint8>(value));
   data_.ForceRollPitchDuringYawTransition = static_cast<quint8>(value);
   mutex->unlock();
   if (changed) { emit forceRollPitchDuringYawTransitionChanged(value); emit ForceRollPitchDuringYawTransitionChanged(static_cast<quint8>(value)); }
}
