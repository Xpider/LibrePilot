...
class StabilizationSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { FlightModeMapCount = 3, VbarPiroCompCount = 2, CruiseControlFlightModeSwitchPosEnableCount = 2, CruiseControlInvertedThrustReversingCount = 2, CruiseControlInvertedPowerOutputCount = 3, LowThrottleZeroIntegralCount = 2, FlightModeAssistMapCount = 2, MeasureBasedDTermCount = 2, ForceRollPitchDuringYawTransitionCount = 2,  };
...
class StabilizationSettings_ForceRollPitchDuringYawTransition : public QObject {
    Q_OBJECT
public:
    enum Enum { False, True };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
...
class UAVOBJECTS_EXPORT StabilizationSettings: public UAVDataObject
{
    ...
    Q_PROPERTY(StabilizationSettings_ForceRollPitchDuringYawTransition::Enum forceRollPitchDuringYawTransition READ forceRollPitchDuringYawTransition WRITE setForceRollPitchDuringYawTransition NOTIFY forceRollPitchDuringYawTransitionChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint8 ForceRollPitchDuringYawTransition READ getForceRollPitchDuringYawTransition WRITE setForceRollPitchDuringYawTransition NOTIFY ForceRollPitchDuringYawTransitionChanged);
...
public:
    ...
    typedef struct {
        ...
        quint8 ForceRollPitchDuringYawTransition;
    ...
    typedef enum { FORCEROLLPITCHDURINGYAWTRANSITION_FALSE=0, FORCEROLLPITCHDURINGYAWTRANSITION_TRUE=1 } ForceRollPitchDuringYawTransitionOptions;


    // Constants
    static const quint32 OBJID = 0x2D186DA0;
    ...
    StabilizationSettings_ForceRollPitchDuringYawTransition::Enum forceRollPitchDuringYawTransition() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getForceRollPitchDuringYawTransition() const { return static_cast<quint8>(forceRollPitchDuringYawTransition()); }
...
public slots:
    ...
    void setForceRollPitchDuringYawTransition(const StabilizationSettings_ForceRollPitchDuringYawTransition::Enum value);
    /*DEPRECATED*/ void setForceRollPitchDuringYawTransition(quint8 value) { setForceRollPitchDuringYawTransition(static_cast<StabilizationSettings_ForceRollPitchDuringYawTransition::Enum>(value)); }
...
signals:
    ...
    void forceRollPitchDuringYawTransitionChanged(const StabilizationSettings_ForceRollPitchDuringYawTransition::Enum value);
    /*DEPRECATED*/ void ForceRollPitchDuringYawTransitionChanged(quint8 value);
