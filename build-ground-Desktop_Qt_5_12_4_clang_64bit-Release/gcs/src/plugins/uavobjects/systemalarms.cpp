...
SystemAlarms::SystemAlarms(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    AlarmElemNames << "SystemConfiguration" << "BootFault" << "OutOfMemory" << "StackOverflow" << "CPUOverload" << "EventSystem" << "Telemetry" << "Receiver" << "ManualControl" << "Actuator" << "Attitude" << "Nav" << "Sensors" << "Magnetometer" << "Airspeed" << "Stabilization" << "Guidance" << "PathPlan" << "Battery" << "FlightTime" << "I2C" << "GPS";
...
void SystemAlarms::emitNotifications()
{
    ...
    emit alarmNavChanged(alarmNav());
    /*DEPRECATED*/ emit Alarm_NavChanged(getAlarm_Nav());
...
SystemAlarms_Alarm::Enum SystemAlarms::alarmNav() const { return alarm(11); }
void SystemAlarms::setAlarmNav(const SystemAlarms_Alarm::Enum value) { setAlarm(11, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmSensors() const { return alarm(12); }
void SystemAlarms::setAlarmSensors(const SystemAlarms_Alarm::Enum value) { setAlarm(12, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmMagnetometer() const { return alarm(13); }
void SystemAlarms::setAlarmMagnetometer(const SystemAlarms_Alarm::Enum value) { setAlarm(13, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmAirspeed() const { return alarm(14); }
void SystemAlarms::setAlarmAirspeed(const SystemAlarms_Alarm::Enum value) { setAlarm(14, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmStabilization() const { return alarm(15); }
void SystemAlarms::setAlarmStabilization(const SystemAlarms_Alarm::Enum value) { setAlarm(15, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmGuidance() const { return alarm(16); }
void SystemAlarms::setAlarmGuidance(const SystemAlarms_Alarm::Enum value) { setAlarm(16, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmPathPlan() const { return alarm(17); }
void SystemAlarms::setAlarmPathPlan(const SystemAlarms_Alarm::Enum value) { setAlarm(17, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmBattery() const { return alarm(18); }
void SystemAlarms::setAlarmBattery(const SystemAlarms_Alarm::Enum value) { setAlarm(18, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmFlightTime() const { return alarm(19); }
void SystemAlarms::setAlarmFlightTime(const SystemAlarms_Alarm::Enum value) { setAlarm(19, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmI2C() const { return alarm(20); }
void SystemAlarms::setAlarmI2C(const SystemAlarms_Alarm::Enum value) { setAlarm(20, value); }
SystemAlarms_Alarm::Enum SystemAlarms::alarmGPS() const { return alarm(21); }
void SystemAlarms::setAlarmGPS(const SystemAlarms_Alarm::Enum value) { setAlarm(21, value); }
