...
RevoSettings::RevoSettings(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    FusionAlgorithmEnumOptions << "None" << "Basic (Complementary)" << "Complementary+Mag" << "Complementary+Mag+GPSOutdoor" << "INS13Indoor" << "GPS Navigation (INS13)" << "GPS Navigation (INS13+CF)" << "Testing (INS Indoor+CF)" << "Acro (No Sensors)";
