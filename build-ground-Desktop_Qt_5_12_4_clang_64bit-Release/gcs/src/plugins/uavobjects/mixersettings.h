...
class MixerSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { Curve2SourceCount = 11, Mixer1TypeCount = 14,  };
...
typedef MixerSettings_Mixer1Type MixerSettings_Mixer2Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer3Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer4Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer5Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer6Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer7Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer8Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer9Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer10Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer11Type;

typedef MixerSettings_Mixer1Type MixerSettings_Mixer12Type;
...
public:
    ...
    // Mixer2Type
    typedef MixerSettings::Mixer1TypeOptions Mixer2TypeOptions;
    // Mixer2Vector
    typedef MixerSettings::Mixer1VectorElem Mixer2VectorElem;
    static const quint32 MIXER2VECTOR_NUMELEM = 5;
    // Mixer3Type
    typedef MixerSettings::Mixer1TypeOptions Mixer3TypeOptions;
    // Mixer3Vector
    typedef MixerSettings::Mixer1VectorElem Mixer3VectorElem;
    static const quint32 MIXER3VECTOR_NUMELEM = 5;
    // Mixer4Type
    typedef MixerSettings::Mixer1TypeOptions Mixer4TypeOptions;
    // Mixer4Vector
    typedef MixerSettings::Mixer1VectorElem Mixer4VectorElem;
    static const quint32 MIXER4VECTOR_NUMELEM = 5;
    // Mixer5Type
    typedef MixerSettings::Mixer1TypeOptions Mixer5TypeOptions;
    // Mixer5Vector
    typedef MixerSettings::Mixer1VectorElem Mixer5VectorElem;
    static const quint32 MIXER5VECTOR_NUMELEM = 5;
    // Mixer6Type
    typedef MixerSettings::Mixer1TypeOptions Mixer6TypeOptions;
    // Mixer6Vector
    typedef MixerSettings::Mixer1VectorElem Mixer6VectorElem;
    static const quint32 MIXER6VECTOR_NUMELEM = 5;
    // Mixer7Type
    typedef MixerSettings::Mixer1TypeOptions Mixer7TypeOptions;
    // Mixer7Vector
    typedef MixerSettings::Mixer1VectorElem Mixer7VectorElem;
    static const quint32 MIXER7VECTOR_NUMELEM = 5;
    // Mixer8Type
    typedef MixerSettings::Mixer1TypeOptions Mixer8TypeOptions;
    // Mixer8Vector
    typedef MixerSettings::Mixer1VectorElem Mixer8VectorElem;
    static const quint32 MIXER8VECTOR_NUMELEM = 5;
    // Mixer9Type
    typedef MixerSettings::Mixer1TypeOptions Mixer9TypeOptions;
    // Mixer9Vector
    typedef MixerSettings::Mixer1VectorElem Mixer9VectorElem;
    static const quint32 MIXER9VECTOR_NUMELEM = 5;
    // Mixer10Type
    typedef MixerSettings::Mixer1TypeOptions Mixer10TypeOptions;
    // Mixer10Vector
    typedef MixerSettings::Mixer1VectorElem Mixer10VectorElem;
    static const quint32 MIXER10VECTOR_NUMELEM = 5;
    // Mixer11Type
    typedef MixerSettings::Mixer1TypeOptions Mixer11TypeOptions;
    // Mixer11Vector
    typedef MixerSettings::Mixer1VectorElem Mixer11VectorElem;
    static const quint32 MIXER11VECTOR_NUMELEM = 5;
    // Mixer12Type
    typedef MixerSettings::Mixer1TypeOptions Mixer12TypeOptions;
    // Mixer12Vector
    typedef MixerSettings::Mixer1VectorElem Mixer12VectorElem;
