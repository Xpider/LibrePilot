...
FlightModeSettings::FlightModeSettings(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    QStringList AlwaysStabilizeWhenArmedThrottleThresholdElemNames;
    AlwaysStabilizeWhenArmedThrottleThresholdElemNames << "0";
    fields.append(new UAVObjectField("AlwaysStabilizeWhenArmedThrottleThreshold", tr(""), "%", UAVObjectField::FLOAT32, AlwaysStabilizeWhenArmedThrottleThresholdElemNames, QStringList(), ""));
    ...
    QStringList BatteryFailsafeDebounceTimerElemNames;
    BatteryFailsafeDebounceTimerElemNames << "0";
    fields.append(new UAVObjectField("BatteryFailsafeDebounceTimer", tr(""), "ms", UAVObjectField::UINT16, BatteryFailsafeDebounceTimerElemNames, QStringList(), ""));
    // Arming
    ...
    QStringList BatteryFailsafeSwitchPositionsElemNames;
    BatteryFailsafeSwitchPositionsElemNames << "Warning" << "Critical";
    fields.append(new UAVObjectField("BatteryFailsafeSwitchPositions", tr(""), "", UAVObjectField::INT8, BatteryFailsafeSwitchPositionsElemNames, QStringList(), ""));
...
{
    // AlwaysStabilizeWhenArmedThrottleThreshold
    data_.AlwaysStabilizeWhenArmedThrottleThreshold = 0.2;
    // ReturnToBaseAltitudeOffset
    ...
    // BatteryFailsafeDebounceTimer
    data_.BatteryFailsafeDebounceTimer = 5000;
    // Arming
    data_.Arming = 0;
    // Stabilization1Settings
    ...
    // BatteryFailsafeSwitchPositions
    data_.BatteryFailsafeSwitchPositions[0] = -1;
    data_.BatteryFailsafeSwitchPositions[1] = -1;
    // FlightModeChangeRestartsPathPlan
...
{
    emit alwaysStabilizeWhenArmedThrottleThresholdChanged(alwaysStabilizeWhenArmedThrottleThreshold());
    /*DEPRECATED*/ emit AlwaysStabilizeWhenArmedThrottleThresholdChanged(getAlwaysStabilizeWhenArmedThrottleThreshold());
    ...
    emit batteryFailsafeDebounceTimerChanged(batteryFailsafeDebounceTimer());
    /*DEPRECATED*/ emit BatteryFailsafeDebounceTimerChanged(getBatteryFailsafeDebounceTimer());
    ...
    emit batteryFailsafeSwitchPositionsWarningChanged(batteryFailsafeSwitchPositionsWarning());
    /*DEPRECATED*/ emit BatteryFailsafeSwitchPositions_WarningChanged(getBatteryFailsafeSwitchPositions_Warning());
    emit batteryFailsafeSwitchPositionsCriticalChanged(batteryFailsafeSwitchPositionsCritical());
    /*DEPRECATED*/ emit BatteryFailsafeSwitchPositions_CriticalChanged(getBatteryFailsafeSwitchPositions_Critical());
...
float FlightModeSettings::alwaysStabilizeWhenArmedThrottleThreshold() const
{
   QMutexLocker locker(mutex);
   return static_cast<float>(data_.AlwaysStabilizeWhenArmedThrottleThreshold);
}
void FlightModeSettings::setAlwaysStabilizeWhenArmedThrottleThreshold(const float value)
{
   mutex->lock();
   bool changed = (data_.AlwaysStabilizeWhenArmedThrottleThreshold != static_cast<float>(value));
   data_.AlwaysStabilizeWhenArmedThrottleThreshold = static_cast<float>(value);
   mutex->unlock();
   if (changed) { emit alwaysStabilizeWhenArmedThrottleThresholdChanged(value); emit AlwaysStabilizeWhenArmedThrottleThresholdChanged(static_cast<float>(value)); }
}
...
quint16 FlightModeSettings::batteryFailsafeDebounceTimer() const
{
   QMutexLocker locker(mutex);
   return static_cast<quint16>(data_.BatteryFailsafeDebounceTimer);
}
void FlightModeSettings::setBatteryFailsafeDebounceTimer(const quint16 value)
{
   mutex->lock();
   bool changed = (data_.BatteryFailsafeDebounceTimer != static_cast<quint16>(value));
   data_.BatteryFailsafeDebounceTimer = static_cast<quint16>(value);
   mutex->unlock();
   if (changed) { emit batteryFailsafeDebounceTimerChanged(value); emit BatteryFailsafeDebounceTimerChanged(static_cast<quint16>(value)); }
}
...
qint16 FlightModeSettings::batteryFailsafeSwitchPositions(quint32 index) const
{
   QMutexLocker locker(mutex);
   return static_cast<qint16>(data_.BatteryFailsafeSwitchPositions[index]);
}
void FlightModeSettings::setBatteryFailsafeSwitchPositions(quint32 index, const qint16 value)
{
   mutex->lock();
   bool changed = (data_.BatteryFailsafeSwitchPositions[index] != static_cast<qint8>(value));
   data_.BatteryFailsafeSwitchPositions[index] = static_cast<qint8>(value);
   mutex->unlock();
   if (changed) { emit batteryFailsafeSwitchPositionsChanged(index, value); emit BatteryFailsafeSwitchPositionsChanged(index, static_cast<qint8>(value)); }
}

qint16 FlightModeSettings::batteryFailsafeSwitchPositionsWarning() const { return batteryFailsafeSwitchPositions(0); }
void FlightModeSettings::setBatteryFailsafeSwitchPositionsWarning(const qint16 value) { setBatteryFailsafeSwitchPositions(0, value); }
qint16 FlightModeSettings::batteryFailsafeSwitchPositionsCritical() const { return batteryFailsafeSwitchPositions(1); }
void FlightModeSettings::setBatteryFailsafeSwitchPositionsCritical(const qint16 value) { setBatteryFailsafeSwitchPositions(1, value); }
