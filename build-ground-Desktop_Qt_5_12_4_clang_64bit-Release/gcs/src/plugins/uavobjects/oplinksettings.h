...
class OPLinkSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { ProtocolCount = 4, LinkTypeCount = 3, MainPortCount = 5, FlexiPortCount = 5, PPMOutRSSICount = 2, RadioPriStreamCount = 5, RadioAuxStreamCount = 5, VCPBridgeCount = 3, MainComSpeedCount = 7, FlexiComSpeedCount = 7, AirDataRateCount = 9, RSSITypeCount = 3, RFBandCount = 3, MaxRFPowerCount = 9,  };
...
class OPLinkSettings_MainPort : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, Telemetry, Serial, PPM, PWM };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class OPLinkSettings_PPMOutRSSI : public QObject {
    Q_OBJECT
public:
...
class OPLinkSettings_RadioPriStream : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, HID, Main, Flexi, VCP };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};

class OPLinkSettings_RadioAuxStream : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, HID, Main, Flexi, VCP };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
...
class OPLinkSettings_VCPBridge : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, Main, Flexi };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};

class OPLinkSettings_MainComSpeed : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, E_4800, E_9600, E_19200, E_38400, E_57600, E_115200 };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};

class OPLinkSettings_FlexiComSpeed : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, E_4800, E_9600, E_19200, E_38400, E_57600, E_115200 };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
...
class OPLinkSettings_AirDataRate : public QObject {
    Q_OBJECT
public:
    enum Enum { E_9600, E_19200, E_32000, E_57600, E_64000, E_100000, E_128000, E_192000, E_256000 };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class OPLinkSettings_RFBand : public QObject {
    Q_OBJECT
public:
    enum Enum { E_433MHz, E_868MHz, E_915MHz };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class UAVOBJECTS_EXPORT OPLinkSettings: public UAVDataObject
{
    ...
    Q_PROPERTY(OPLinkSettings_PPMOutRSSI::Enum ppmOutRSSI READ ppmOutRSSI WRITE setPPMOutRSSI NOTIFY ppmOutRSSIChanged)
    Q_PROPERTY(OPLinkSettings_RadioPriStream::Enum radioPriStream READ radioPriStream WRITE setRadioPriStream NOTIFY radioPriStreamChanged)
    Q_PROPERTY(OPLinkSettings_RadioAuxStream::Enum radioAuxStream READ radioAuxStream WRITE setRadioAuxStream NOTIFY radioAuxStreamChanged)
    Q_PROPERTY(OPLinkSettings_VCPBridge::Enum vcpBridge READ vcpBridge WRITE setVCPBridge NOTIFY vcpBridgeChanged)
    Q_PROPERTY(OPLinkSettings_MainComSpeed::Enum mainComSpeed READ mainComSpeed WRITE setMainComSpeed NOTIFY mainComSpeedChanged)
    Q_PROPERTY(OPLinkSettings_FlexiComSpeed::Enum flexiComSpeed READ flexiComSpeed WRITE setFlexiComSpeed NOTIFY flexiComSpeedChanged)
    Q_PROPERTY(OPLinkSettings_AirDataRate::Enum airDataRate READ airDataRate WRITE setAirDataRate NOTIFY airDataRateChanged)
    ...
    Q_PROPERTY(quint16 rfXtalCap READ rfXtalCap WRITE setRFXtalCap NOTIFY rfXtalCapChanged)
    ...
    Q_PROPERTY(OPLinkSettings_RFBand::Enum rfBand READ rfBand WRITE setRFBand NOTIFY rfBandChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint8 PPMOutRSSI READ getPPMOutRSSI WRITE setPPMOutRSSI NOTIFY PPMOutRSSIChanged);
    /*DEPRECATED*/ Q_PROPERTY(quint8 RadioPriStream READ getRadioPriStream WRITE setRadioPriStream NOTIFY RadioPriStreamChanged);
    /*DEPRECATED*/ Q_PROPERTY(quint8 RadioAuxStream READ getRadioAuxStream WRITE setRadioAuxStream NOTIFY RadioAuxStreamChanged);
    /*DEPRECATED*/ Q_PROPERTY(quint8 VCPBridge READ getVCPBridge WRITE setVCPBridge NOTIFY VCPBridgeChanged);
    /*DEPRECATED*/ Q_PROPERTY(quint8 MainComSpeed READ getMainComSpeed WRITE setMainComSpeed NOTIFY MainComSpeedChanged);
    /*DEPRECATED*/ Q_PROPERTY(quint8 FlexiComSpeed READ getFlexiComSpeed WRITE setFlexiComSpeed NOTIFY FlexiComSpeedChanged);
    /*DEPRECATED*/ Q_PROPERTY(quint8 AirDataRate READ getAirDataRate WRITE setAirDataRate NOTIFY AirDataRateChanged);
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint8 RFXtalCap READ getRFXtalCap WRITE setRFXtalCap NOTIFY RFXtalCapChanged);
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint8 RFBand READ getRFBand WRITE setRFBand NOTIFY RFBandChanged);
...
public:
    ...
    typedef struct {
        ...
        quint8 FlexiPort;
        quint8 PPMOutRSSI;
        quint8 RadioPriStream;
        quint8 RadioAuxStream;
        quint8 VCPBridge;
        quint8 MainComSpeed;
        quint8 FlexiComSpeed;
        quint8 AirDataRate;
        quint8 Version;
        quint8 RSSIType;
        quint8 RFPower;
    ...
    // PPMOutRSSI
    typedef enum { PPMOUTRSSI_FALSE=0, PPMOUTRSSI_TRUE=1 } PPMOutRSSIOptions;
    // RadioPriStream
    typedef enum { RADIOPRISTREAM_DISABLED=0, RADIOPRISTREAM_HID=1, RADIOPRISTREAM_MAIN=2, RADIOPRISTREAM_FLEXI=3, RADIOPRISTREAM_VCP=4 } RadioPriStreamOptions;
    // RadioAuxStream
    typedef enum { RADIOAUXSTREAM_DISABLED=0, RADIOAUXSTREAM_HID=1, RADIOAUXSTREAM_MAIN=2, RADIOAUXSTREAM_FLEXI=3, RADIOAUXSTREAM_VCP=4 } RadioAuxStreamOptions;
    // VCPBridge
    typedef enum { VCPBRIDGE_DISABLED=0, VCPBRIDGE_MAIN=1, VCPBRIDGE_FLEXI=2 } VCPBridgeOptions;
    // MainComSpeed
    typedef enum { MAINCOMSPEED_DISABLED=0, MAINCOMSPEED_4800=1, MAINCOMSPEED_9600=2, MAINCOMSPEED_19200=3, MAINCOMSPEED_38400=4, MAINCOMSPEED_57600=5, MAINCOMSPEED_115200=6 } MainComSpeedOptions;
    // FlexiComSpeed
    typedef enum { FLEXICOMSPEED_DISABLED=0, FLEXICOMSPEED_4800=1, FLEXICOMSPEED_9600=2, FLEXICOMSPEED_19200=3, FLEXICOMSPEED_38400=4, FLEXICOMSPEED_57600=5, FLEXICOMSPEED_115200=6 } FlexiComSpeedOptions;
    // AirDataRate
    typedef enum { AIRDATARATE_9600=0, AIRDATARATE_19200=1, AIRDATARATE_32000=2, AIRDATARATE_57600=3, AIRDATARATE_64000=4, AIRDATARATE_100000=5, AIRDATARATE_128000=6, AIRDATARATE_192000=7, AIRDATARATE_256000=8 } AirDataRateOptions;
    // Version
    // RSSIType
    ...
    // MaxChannel
    // RFBand
    typedef enum { RFBAND_433MHZ=0, RFBAND_868MHZ=1, RFBAND_915MHZ=2 } RFBandOptions;
    // MaxRFPower
    ...
    // Constants
    static const quint32 OBJID = 0x885DAD90;
    ...
    OPLinkSettings_PPMOutRSSI::Enum ppmOutRSSI() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getPPMOutRSSI() const { return static_cast<quint8>(ppmOutRSSI()); }
    OPLinkSettings_RadioPriStream::Enum radioPriStream() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getRadioPriStream() const { return static_cast<quint8>(radioPriStream()); }
    OPLinkSettings_RadioAuxStream::Enum radioAuxStream() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getRadioAuxStream() const { return static_cast<quint8>(radioAuxStream()); }
    OPLinkSettings_VCPBridge::Enum vcpBridge() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getVCPBridge() const { return static_cast<quint8>(vcpBridge()); }
    OPLinkSettings_MainComSpeed::Enum mainComSpeed() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getMainComSpeed() const { return static_cast<quint8>(mainComSpeed()); }
    OPLinkSettings_FlexiComSpeed::Enum flexiComSpeed() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getFlexiComSpeed() const { return static_cast<quint8>(flexiComSpeed()); }
    OPLinkSettings_AirDataRate::Enum airDataRate() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getAirDataRate() const { return static_cast<quint8>(airDataRate()); }
    ...
    quint16 rfXtalCap() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getRFXtalCap() const { return static_cast<quint8>(rfXtalCap()); }
    ...
    OPLinkSettings_RFBand::Enum rfBand() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getRFBand() const { return static_cast<quint8>(rfBand()); }
...
public slots:
    ...
    void setPPMOutRSSI(const OPLinkSettings_PPMOutRSSI::Enum value);
    /*DEPRECATED*/ void setPPMOutRSSI(quint8 value) { setPPMOutRSSI(static_cast<OPLinkSettings_PPMOutRSSI::Enum>(value)); }
    void setRadioPriStream(const OPLinkSettings_RadioPriStream::Enum value);
    /*DEPRECATED*/ void setRadioPriStream(quint8 value) { setRadioPriStream(static_cast<OPLinkSettings_RadioPriStream::Enum>(value)); }
    void setRadioAuxStream(const OPLinkSettings_RadioAuxStream::Enum value);
    /*DEPRECATED*/ void setRadioAuxStream(quint8 value) { setRadioAuxStream(static_cast<OPLinkSettings_RadioAuxStream::Enum>(value)); }
    void setVCPBridge(const OPLinkSettings_VCPBridge::Enum value);
    /*DEPRECATED*/ void setVCPBridge(quint8 value) { setVCPBridge(static_cast<OPLinkSettings_VCPBridge::Enum>(value)); }
    void setMainComSpeed(const OPLinkSettings_MainComSpeed::Enum value);
    /*DEPRECATED*/ void setMainComSpeed(quint8 value) { setMainComSpeed(static_cast<OPLinkSettings_MainComSpeed::Enum>(value)); }
    void setFlexiComSpeed(const OPLinkSettings_FlexiComSpeed::Enum value);
    /*DEPRECATED*/ void setFlexiComSpeed(quint8 value) { setFlexiComSpeed(static_cast<OPLinkSettings_FlexiComSpeed::Enum>(value)); }
    void setAirDataRate(const OPLinkSettings_AirDataRate::Enum value);
    /*DEPRECATED*/ void setAirDataRate(quint8 value) { setAirDataRate(static_cast<OPLinkSettings_AirDataRate::Enum>(value)); }
    ...
    void setRFXtalCap(const quint16 value);
    /*DEPRECATED*/ void setRFXtalCap(quint8 value) { setRFXtalCap(static_cast<quint16>(value)); }
    ...
    void setRFBand(const OPLinkSettings_RFBand::Enum value);
    /*DEPRECATED*/ void setRFBand(quint8 value) { setRFBand(static_cast<OPLinkSettings_RFBand::Enum>(value)); }
...
signals:
    ...
    void ppmOutRSSIChanged(const OPLinkSettings_PPMOutRSSI::Enum value);
    /*DEPRECATED*/ void PPMOutRSSIChanged(quint8 value);
    void radioPriStreamChanged(const OPLinkSettings_RadioPriStream::Enum value);
    /*DEPRECATED*/ void RadioPriStreamChanged(quint8 value);
    void radioAuxStreamChanged(const OPLinkSettings_RadioAuxStream::Enum value);
    /*DEPRECATED*/ void RadioAuxStreamChanged(quint8 value);
    void vcpBridgeChanged(const OPLinkSettings_VCPBridge::Enum value);
    /*DEPRECATED*/ void VCPBridgeChanged(quint8 value);
    void mainComSpeedChanged(const OPLinkSettings_MainComSpeed::Enum value);
    /*DEPRECATED*/ void MainComSpeedChanged(quint8 value);
    void flexiComSpeedChanged(const OPLinkSettings_FlexiComSpeed::Enum value);
    /*DEPRECATED*/ void FlexiComSpeedChanged(quint8 value);
    void airDataRateChanged(const OPLinkSettings_AirDataRate::Enum value);
    /*DEPRECATED*/ void AirDataRateChanged(quint8 value);
    ...
    void rfXtalCapChanged(const quint16 value);
    /*DEPRECATED*/ void RFXtalCapChanged(quint8 value);
    ...
    void rfBandChanged(const OPLinkSettings_RFBand::Enum value);
    /*DEPRECATED*/ void RFBandChanged(quint8 value);
