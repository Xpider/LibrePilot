...
EKFConfiguration::EKFConfiguration(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    QStringList MapMagnetometerToHorizontalPlaneElemNames;
    MapMagnetometerToHorizontalPlaneElemNames << "0";
    QStringList MapMagnetometerToHorizontalPlaneEnumOptions;
    MapMagnetometerToHorizontalPlaneEnumOptions << "False" << "True";
    fields.append(new UAVObjectField("MapMagnetometerToHorizontalPlane", tr("Set to True to suppress effect of magnetometers on Roll+Pitch State estimate"), "bool", UAVObjectField::ENUM, MapMagnetometerToHorizontalPlaneElemNames, MapMagnetometerToHorizontalPlaneEnumOptions, ""));
...
void EKFConfiguration::setDefaultFieldValues()
{
    ...
    data_.FakeR[2] = 1000;
    // MapMagnetometerToHorizontalPlane
    data_.MapMagnetometerToHorizontalPlane = 1;
...
void EKFConfiguration::emitNotifications()
{
    ...
    emit mapMagnetometerToHorizontalPlaneChanged(mapMagnetometerToHorizontalPlane());
    /*DEPRECATED*/ emit MapMagnetometerToHorizontalPlaneChanged(getMapMagnetometerToHorizontalPlane());
...
void EKFConfiguration::registerQMLTypes() {
    ...
    qmlRegisterType<EKFConfiguration_MapMagnetometerToHorizontalPlane>("UAVTalk.EKFConfiguration", 1, 0, "MapMagnetometerToHorizontalPlane");
...
EKFConfiguration_MapMagnetometerToHorizontalPlane::Enum EKFConfiguration::mapMagnetometerToHorizontalPlane() const
{
   QMutexLocker locker(mutex);
   return static_cast<EKFConfiguration_MapMagnetometerToHorizontalPlane::Enum>(data_.MapMagnetometerToHorizontalPlane);
}
void EKFConfiguration::setMapMagnetometerToHorizontalPlane(const EKFConfiguration_MapMagnetometerToHorizontalPlane::Enum value)
{
   mutex->lock();
   bool changed = (data_.MapMagnetometerToHorizontalPlane != static_cast<quint8>(value));
   data_.MapMagnetometerToHorizontalPlane = static_cast<quint8>(value);
   mutex->unlock();
   if (changed) { emit mapMagnetometerToHorizontalPlaneChanged(value); emit MapMagnetometerToHorizontalPlaneChanged(static_cast<quint8>(value)); }
}
