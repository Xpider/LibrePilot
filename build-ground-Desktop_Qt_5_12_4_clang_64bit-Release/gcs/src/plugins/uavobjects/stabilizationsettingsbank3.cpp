...
float StabilizationSettingsBank3::attitudeFeedForward(quint32 index) const
{
   QMutexLocker locker(mutex);
   return static_cast<float>(data_.AttitudeFeedForward[index]);
}
void StabilizationSettingsBank3::setAttitudeFeedForward(quint32 index, const float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::attitudeFeedForwardRoll() const { return attitudeFeedForward(0); }
void StabilizationSettingsBank3::setAttitudeFeedForwardRoll(const float value) { setAttitudeFeedForward(0, value); }
float StabilizationSettingsBank3::attitudeFeedForwardPitch() const { return attitudeFeedForward(1); }
void StabilizationSettingsBank3::setAttitudeFeedForwardPitch(const float value) { setAttitudeFeedForward(1, value); }
float StabilizationSettingsBank3::attitudeFeedForwardYaw() const { return attitudeFeedForward(2); }
void StabilizationSettingsBank3::setAttitudeFeedForwardYaw(const float value) { setAttitudeFeedForward(2, value); }
