...
class FlightBatterySettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { TypeCount = 6, ResetConsumedEnergyCount = 2,  };
...
class FlightBatterySettings_Type : public QObject {
    Q_OBJECT
public:
    enum Enum { LiPo, LiHV, A123, LiCo, LiFeSO4, None };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class UAVOBJECTS_EXPORT FlightBatterySettings: public UAVDataObject
{
    ...
    Q_PROPERTY(float cellVoltageThresholdsCritical READ cellVoltageThresholdsCritical WRITE setCellVoltageThresholdsCritical NOTIFY cellVoltageThresholdsCriticalChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(float CellVoltageThresholds_Critical READ getCellVoltageThresholds_Critical WRITE setCellVoltageThresholds_Critical NOTIFY CellVoltageThresholds_CriticalChanged);
...
public:
    ...
    typedef enum { CELLVOLTAGETHRESHOLDS_WARNING=0, CELLVOLTAGETHRESHOLDS_CRITICAL=1 } CellVoltageThresholdsElem;
    ...
    // Type
    typedef enum { TYPE_LIPO=0, TYPE_LIHV=1, TYPE_A123=2, TYPE_LICO=3, TYPE_LIFESO4=4, TYPE_NONE=5 } TypeOptions;
    // NbCells
    // ResetConsumedEnergy
    ...
    // Constants
    static const quint32 OBJID = 0x2B081FC0;
    ...
    float cellVoltageThresholdsCritical() const;
    /*DEPRECATED*/ Q_INVOKABLE float getCellVoltageThresholds_Critical() const { return static_cast<float>(cellVoltageThresholdsCritical()); }
...
public slots:
    ...
    void setCellVoltageThresholdsCritical(const float value);
    /*DEPRECATED*/ void setCellVoltageThresholds_Critical(float value) { setCellVoltageThresholdsCritical(static_cast<float>(value)); }
...
signals:
    ...
    void cellVoltageThresholdsCriticalChanged(const float value);
    /*DEPRECATED*/ void CellVoltageThresholds_CriticalChanged(float value);
