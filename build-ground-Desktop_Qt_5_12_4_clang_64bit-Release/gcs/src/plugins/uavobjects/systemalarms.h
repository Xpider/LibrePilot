...
class UAVOBJECTS_EXPORT SystemAlarms: public UAVDataObject
{
    ...
    Q_PROPERTY(SystemAlarms_Alarm::Enum alarmNav READ alarmNav WRITE setAlarmNav NOTIFY alarmNavChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint8 Alarm_Nav READ getAlarm_Nav WRITE setAlarm_Nav NOTIFY Alarm_NavChanged);
...
public:
    ...
    typedef enum { ALARM_SYSTEMCONFIGURATION=0, ALARM_BOOTFAULT=1, ALARM_OUTOFMEMORY=2, ALARM_STACKOVERFLOW=3, ALARM_CPUOVERLOAD=4, ALARM_EVENTSYSTEM=5, ALARM_TELEMETRY=6, ALARM_RECEIVER=7, ALARM_MANUALCONTROL=8, ALARM_ACTUATOR=9, ALARM_ATTITUDE=10, ALARM_NAV=11, ALARM_SENSORS=12, ALARM_MAGNETOMETER=13, ALARM_AIRSPEED=14, ALARM_STABILIZATION=15, ALARM_GUIDANCE=16, ALARM_PATHPLAN=17, ALARM_BATTERY=18, ALARM_FLIGHTTIME=19, ALARM_I2C=20, ALARM_GPS=21 } AlarmElem;
    static const quint32 ALARM_NUMELEM = 22;
    // ExtendedAlarmStatus
    ...
    // Constants
    static const quint32 OBJID = 0x85C20346;
    ...
    SystemAlarms_Alarm::Enum alarmNav() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getAlarm_Nav() const { return static_cast<quint8>(alarmNav()); }
...
public slots:
    ...
    void setAlarmNav(const SystemAlarms_Alarm::Enum value);
    /*DEPRECATED*/ void setAlarm_Nav(quint8 value) { setAlarmNav(static_cast<SystemAlarms_Alarm::Enum>(value)); }
...
signals:
    ...
    void alarmNavChanged(const SystemAlarms_Alarm::Enum value);
    /*DEPRECATED*/ void Alarm_NavChanged(quint8 value);
