...
{
    Q_OBJECT
    Q_PROPERTY(float alwaysStabilizeWhenArmedThrottleThreshold READ alwaysStabilizeWhenArmedThrottleThreshold WRITE setAlwaysStabilizeWhenArmedThrottleThreshold NOTIFY alwaysStabilizeWhenArmedThrottleThresholdChanged)
    ...
    Q_PROPERTY(quint16 batteryFailsafeDebounceTimer READ batteryFailsafeDebounceTimer WRITE setBatteryFailsafeDebounceTimer NOTIFY batteryFailsafeDebounceTimerChanged)
    ...
    Q_PROPERTY(qint16 batteryFailsafeSwitchPositionsWarning READ batteryFailsafeSwitchPositionsWarning WRITE setBatteryFailsafeSwitchPositionsWarning NOTIFY batteryFailsafeSwitchPositionsWarningChanged)
    Q_PROPERTY(qint16 batteryFailsafeSwitchPositionsCritical READ batteryFailsafeSwitchPositionsCritical WRITE setBatteryFailsafeSwitchPositionsCritical NOTIFY batteryFailsafeSwitchPositionsCriticalChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(float AlwaysStabilizeWhenArmedThrottleThreshold READ getAlwaysStabilizeWhenArmedThrottleThreshold WRITE setAlwaysStabilizeWhenArmedThrottleThreshold NOTIFY AlwaysStabilizeWhenArmedThrottleThresholdChanged);
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint16 BatteryFailsafeDebounceTimer READ getBatteryFailsafeDebounceTimer WRITE setBatteryFailsafeDebounceTimer NOTIFY BatteryFailsafeDebounceTimerChanged);
    ...
    /*DEPRECATED*/ Q_PROPERTY(qint8 BatteryFailsafeSwitchPositions_Warning READ getBatteryFailsafeSwitchPositions_Warning WRITE setBatteryFailsafeSwitchPositions_Warning NOTIFY BatteryFailsafeSwitchPositions_WarningChanged);
    /*DEPRECATED*/ Q_PROPERTY(qint8 BatteryFailsafeSwitchPositions_Critical READ getBatteryFailsafeSwitchPositions_Critical WRITE setBatteryFailsafeSwitchPositions_Critical NOTIFY BatteryFailsafeSwitchPositions_CriticalChanged);
...
public:
    ...
    typedef struct {
        ...
        quint16 BatteryFailsafeDebounceTimer;
        quint8 Arming;
        ...
        qint8 BatteryFailsafeSwitchPositions[2];
    ...
    typedef enum { BATTERYFAILSAFESWITCHPOSITIONS_WARNING=0, BATTERYFAILSAFESWITCHPOSITIONS_CRITICAL=1 } BatteryFailsafeSwitchPositionsElem;
    static const quint32 BATTERYFAILSAFESWITCHPOSITIONS_NUMELEM = 2;
    ...
    // Constants
    static const quint32 OBJID = 0xD56F2952;
    ...
    float alwaysStabilizeWhenArmedThrottleThreshold() const;
    /*DEPRECATED*/ Q_INVOKABLE float getAlwaysStabilizeWhenArmedThrottleThreshold() const { return static_cast<float>(alwaysStabilizeWhenArmedThrottleThreshold()); }
    ...
    quint16 batteryFailsafeDebounceTimer() const;
    /*DEPRECATED*/ Q_INVOKABLE quint16 getBatteryFailsafeDebounceTimer() const { return static_cast<quint16>(batteryFailsafeDebounceTimer()); }
    ...
    Q_INVOKABLE qint16 batteryFailsafeSwitchPositions(quint32 index) const;
    /*DEPRECATED*/ Q_INVOKABLE qint8 getBatteryFailsafeSwitchPositions(quint32 index) const { return static_cast<qint8>(batteryFailsafeSwitchPositions(index)); }
    qint16 batteryFailsafeSwitchPositionsWarning() const;
    /*DEPRECATED*/ Q_INVOKABLE qint8 getBatteryFailsafeSwitchPositions_Warning() const { return static_cast<qint8>(batteryFailsafeSwitchPositionsWarning()); }
    qint16 batteryFailsafeSwitchPositionsCritical() const;
    /*DEPRECATED*/ Q_INVOKABLE qint8 getBatteryFailsafeSwitchPositions_Critical() const { return static_cast<qint8>(batteryFailsafeSwitchPositionsCritical()); }
...
public slots:
    void setAlwaysStabilizeWhenArmedThrottleThreshold(const float value);
    ...
    void setBatteryFailsafeDebounceTimer(const quint16 value);
    ...
    Q_INVOKABLE void setBatteryFailsafeSwitchPositions(quint32 index, const qint16 value);
    /*DEPRECATED*/ void setBatteryFailsafeSwitchPositions(quint32 index, qint8 value) { setBatteryFailsafeSwitchPositions(index, static_cast<qint16>(value)); }
    void setBatteryFailsafeSwitchPositionsWarning(const qint16 value);
    /*DEPRECATED*/ void setBatteryFailsafeSwitchPositions_Warning(qint8 value) { setBatteryFailsafeSwitchPositionsWarning(static_cast<qint16>(value)); }
    void setBatteryFailsafeSwitchPositionsCritical(const qint16 value);
    /*DEPRECATED*/ void setBatteryFailsafeSwitchPositions_Critical(qint8 value) { setBatteryFailsafeSwitchPositionsCritical(static_cast<qint16>(value)); }
...
signals:
    void alwaysStabilizeWhenArmedThrottleThresholdChanged(const float value);
    /*DEPRECATED*/ void AlwaysStabilizeWhenArmedThrottleThresholdChanged(float value);
    ...
    void batteryFailsafeDebounceTimerChanged(const quint16 value);
    /*DEPRECATED*/ void BatteryFailsafeDebounceTimerChanged(quint16 value);
    ...
    void batteryFailsafeSwitchPositionsChanged(quint32 index, const qint16 value);
    /*DEPRECATED*/ void BatteryFailsafeSwitchPositionsChanged(quint32 index, qint8 value);
    void batteryFailsafeSwitchPositionsWarningChanged(const qint16 value);
    /*DEPRECATED*/ void BatteryFailsafeSwitchPositions_WarningChanged(qint8 value);
    void batteryFailsafeSwitchPositionsCriticalChanged(const qint16 value);
    /*DEPRECATED*/ void BatteryFailsafeSwitchPositions_CriticalChanged(qint8 value);
