...
class EKFConfigurationConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { MapMagnetometerToHorizontalPlaneCount = 2,  };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};

class EKFConfiguration_MapMagnetometerToHorizontalPlane : public QObject {
    Q_OBJECT
public:
...
class UAVOBJECTS_EXPORT EKFConfiguration: public UAVDataObject
{
    ...
    Q_PROPERTY(EKFConfiguration_MapMagnetometerToHorizontalPlane::Enum mapMagnetometerToHorizontalPlane READ mapMagnetometerToHorizontalPlane WRITE setMapMagnetometerToHorizontalPlane NOTIFY mapMagnetometerToHorizontalPlaneChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint8 MapMagnetometerToHorizontalPlane READ getMapMagnetometerToHorizontalPlane WRITE setMapMagnetometerToHorizontalPlane NOTIFY MapMagnetometerToHorizontalPlaneChanged);
...
public:
    ...
    typedef struct {
        ...
        float R[10];
        float FakeR[3];
        quint8 MapMagnetometerToHorizontalPlane;
    ...
    typedef enum { MAPMAGNETOMETERTOHORIZONTALPLANE_FALSE=0, MAPMAGNETOMETERTOHORIZONTALPLANE_TRUE=1 } MapMagnetometerToHorizontalPlaneOptions;


    // Constants
    static const quint32 OBJID = 0x5D1D071A;
    ...
    EKFConfiguration_MapMagnetometerToHorizontalPlane::Enum mapMagnetometerToHorizontalPlane() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getMapMagnetometerToHorizontalPlane() const { return static_cast<quint8>(mapMagnetometerToHorizontalPlane()); }
...
public slots:
    ...
    void setMapMagnetometerToHorizontalPlane(const EKFConfiguration_MapMagnetometerToHorizontalPlane::Enum value);
    /*DEPRECATED*/ void setMapMagnetometerToHorizontalPlane(quint8 value) { setMapMagnetometerToHorizontalPlane(static_cast<EKFConfiguration_MapMagnetometerToHorizontalPlane::Enum>(value)); }
...
signals:
    ...
    void mapMagnetometerToHorizontalPlaneChanged(const EKFConfiguration_MapMagnetometerToHorizontalPlane::Enum value);
    /*DEPRECATED*/ void MapMagnetometerToHorizontalPlaneChanged(quint8 value);
