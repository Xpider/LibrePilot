...
float StabilizationBank::attitudeFeedForward(quint32 index) const
{
   QMutexLocker locker(mutex);
   return static_cast<float>(data_.AttitudeFeedForward[index]);
}
void StabilizationBank::setAttitudeFeedForward(quint32 index, const float value)
{
   mutex->lock();
...
float StabilizationBank::attitudeFeedForwardRoll() const { return attitudeFeedForward(0); }
void StabilizationBank::setAttitudeFeedForwardRoll(const float value) { setAttitudeFeedForward(0, value); }
float StabilizationBank::attitudeFeedForwardPitch() const { return attitudeFeedForward(1); }
void StabilizationBank::setAttitudeFeedForwardPitch(const float value) { setAttitudeFeedForward(1, value); }
float StabilizationBank::attitudeFeedForwardYaw() const { return attitudeFeedForward(2); }
void StabilizationBank::setAttitudeFeedForwardYaw(const float value) { setAttitudeFeedForward(2, value); }
