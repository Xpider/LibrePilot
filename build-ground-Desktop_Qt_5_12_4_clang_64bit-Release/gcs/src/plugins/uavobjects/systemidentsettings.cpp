...
SystemIdentSettings::SystemIdentSettings(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    fields.append(new UAVObjectField("DerivativeFactor", tr("Setting: Multiplicative factor. If you have D term oscillations, reduce it toward zero and it will reduce PID D terms."), "", UAVObjectField::FLOAT32, DerivativeFactorElemNames, QStringList(), "%BE:0:1"));
    // OuterLoopKpSoftClamp
    QStringList OuterLoopKpSoftClampElemNames;
    OuterLoopKpSoftClampElemNames << "0";
    fields.append(new UAVObjectField("OuterLoopKpSoftClamp", tr("Setting: Change this to change the outer loop Kp and Ki limiting"), "", UAVObjectField::FLOAT32, OuterLoopKpSoftClampElemNames, QStringList(), "%BE:0:100"));
    // SmoothQuickValue
    QStringList SmoothQuickValueElemNames;
    SmoothQuickValueElemNames << "0";
    fields.append(new UAVObjectField("SmoothQuickValue", tr("Remembers the value of the FMS 3x toggle (-1 to +1 range)"), "", UAVObjectField::FLOAT32, SmoothQuickValueElemNames, QStringList(), ""));
    // GyroReadTimeAverage
    ...
    QStringList DestinationPidBankEnumOptions;
    DestinationPidBankEnumOptions << "Bank1" << "Bank2" << "Bank3";
    fields.append(new UAVObjectField("DestinationPidBank", tr("Setting: Which bank the calculated PIDs will be stored in after tuning"), "bank#", UAVObjectField::ENUM, DestinationPidBankElemNames, DestinationPidBankEnumOptions, ""));
    // TuningDuration
    ...
    ThrustControlEnumOptions << "Manual" << "AltitudeVario";
    fields.append(new UAVObjectField("ThrustControl", tr("Setting: Manual is direct control, AltitudeVario helps to maintain altitude"), "", UAVObjectField::ENUM, ThrustControlElemNames, ThrustControlEnumOptions, ""));
    // SmoothQuickSource
    QStringList SmoothQuickSourceElemNames;
    SmoothQuickSourceElemNames << "0";
    QStringList SmoothQuickSourceEnumOptions;
    SmoothQuickSourceEnumOptions << "Disabled" << "Accessory0" << "Accessory1" << "Accessory2" << "Accessory3" << "FMSToggle3pos" << "FMSToggle5pos" << "FMSToggle7pos";
    fields.append(new UAVObjectField("SmoothQuickSource", tr("Setting: Choose Accessory or FMS 3x toggle method with 3, 5, 7 positions"), "", UAVObjectField::ENUM, SmoothQuickSourceElemNames, SmoothQuickSourceEnumOptions, ""));
    // DisableSanityChecks
...
void SystemIdentSettings::setDefaultFieldValues()
{
    ...
    // OuterLoopKpSoftClamp
    data_.OuterLoopKpSoftClamp = 6.5;
    // SmoothQuickValue
    ...
    // DestinationPidBank
    data_.DestinationPidBank = 2;
    // TuningDuration
    data_.TuningDuration = 60;
    // ThrustControl
    data_.ThrustControl = 0;
    // SmoothQuickSource
    data_.SmoothQuickSource = 6;
    // DisableSanityChecks
...
void SystemIdentSettings::emitNotifications()
{
    ...
    emit outerLoopKpSoftClampChanged(outerLoopKpSoftClamp());
    /*DEPRECATED*/ emit OuterLoopKpSoftClampChanged(getOuterLoopKpSoftClamp());
...
void SystemIdentSettings::registerQMLTypes() {
    ...
    qmlRegisterType<SystemIdentSettings_DestinationPidBank>("UAVTalk.SystemIdentSettings", 1, 0, "DestinationPidBank");
    qmlRegisterType<SystemIdentSettings_ThrustControl>("UAVTalk.SystemIdentSettings", 1, 0, "ThrustControl");
    qmlRegisterType<SystemIdentSettings_SmoothQuickSource>("UAVTalk.SystemIdentSettings", 1, 0, "SmoothQuickSource");
...
float SystemIdentSettings::outerLoopKpSoftClamp() const
{
   QMutexLocker locker(mutex);
   return static_cast<float>(data_.OuterLoopKpSoftClamp);
}
void SystemIdentSettings::setOuterLoopKpSoftClamp(const float value)
{
   mutex->lock();
   bool changed = (data_.OuterLoopKpSoftClamp != static_cast<float>(value));
   data_.OuterLoopKpSoftClamp = static_cast<float>(value);
   mutex->unlock();
   if (changed) { emit outerLoopKpSoftClampChanged(value); emit OuterLoopKpSoftClampChanged(static_cast<float>(value)); }
}
...
SystemIdentSettings_DestinationPidBank::Enum SystemIdentSettings::destinationPidBank() const
{
   QMutexLocker locker(mutex);
   return static_cast<SystemIdentSettings_DestinationPidBank::Enum>(data_.DestinationPidBank);
}
void SystemIdentSettings::setDestinationPidBank(const SystemIdentSettings_DestinationPidBank::Enum value)
{
   mutex->lock();
...
SystemIdentSettings_ThrustControl::Enum SystemIdentSettings::thrustControl() const
{
   QMutexLocker locker(mutex);
   return static_cast<SystemIdentSettings_ThrustControl::Enum>(data_.ThrustControl);
}
void SystemIdentSettings::setThrustControl(const SystemIdentSettings_ThrustControl::Enum value)
{
   mutex->lock();
...
SystemIdentSettings_SmoothQuickSource::Enum SystemIdentSettings::smoothQuickSource() const
{
   QMutexLocker locker(mutex);
   return static_cast<SystemIdentSettings_SmoothQuickSource::Enum>(data_.SmoothQuickSource);
}
void SystemIdentSettings::setSmoothQuickSource(const SystemIdentSettings_SmoothQuickSource::Enum value)
{
   mutex->lock();
