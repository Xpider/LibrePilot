...
class SystemIdentSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { CalculateYawCount = 3, DestinationPidBankCount = 3, ThrustControlCount = 2, SmoothQuickSourceCount = 8, DisableSanityChecksCount = 2, CompleteCount = 2,  };
...
class SystemIdentSettings_DestinationPidBank : public QObject {
    Q_OBJECT
public:
...
class SystemIdentSettings_ThrustControl : public QObject {
    Q_OBJECT
public:
    enum Enum { Manual, AltitudeVario };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};

class SystemIdentSettings_SmoothQuickSource : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, Accessory0, Accessory1, Accessory2, Accessory3, FMSToggle3pos, FMSToggle5pos, FMSToggle7pos };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class UAVOBJECTS_EXPORT SystemIdentSettings: public UAVDataObject
{
    ...
    Q_PROPERTY(float outerLoopKpSoftClamp READ outerLoopKpSoftClamp WRITE setOuterLoopKpSoftClamp NOTIFY outerLoopKpSoftClampChanged)
    ...
    Q_PROPERTY(SystemIdentSettings_DestinationPidBank::Enum destinationPidBank READ destinationPidBank WRITE setDestinationPidBank NOTIFY destinationPidBankChanged)
    Q_PROPERTY(quint16 tuningDuration READ tuningDuration WRITE setTuningDuration NOTIFY tuningDurationChanged)
    Q_PROPERTY(SystemIdentSettings_ThrustControl::Enum thrustControl READ thrustControl WRITE setThrustControl NOTIFY thrustControlChanged)
    Q_PROPERTY(SystemIdentSettings_SmoothQuickSource::Enum smoothQuickSource READ smoothQuickSource WRITE setSmoothQuickSource NOTIFY smoothQuickSourceChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(float OuterLoopKpSoftClamp READ getOuterLoopKpSoftClamp WRITE setOuterLoopKpSoftClamp NOTIFY OuterLoopKpSoftClampChanged);
...
public:
    ...
    // DestinationPidBank
    typedef enum { DESTINATIONPIDBANK_BANK1=0, DESTINATIONPIDBANK_BANK2=1, DESTINATIONPIDBANK_BANK3=2 } DestinationPidBankOptions;
    // TuningDuration
    // ThrustControl
    typedef enum { THRUSTCONTROL_MANUAL=0, THRUSTCONTROL_ALTITUDEVARIO=1 } ThrustControlOptions;
    // SmoothQuickSource
    typedef enum { SMOOTHQUICKSOURCE_DISABLED=0, SMOOTHQUICKSOURCE_ACCESSORY0=1, SMOOTHQUICKSOURCE_ACCESSORY1=2, SMOOTHQUICKSOURCE_ACCESSORY2=3, SMOOTHQUICKSOURCE_ACCESSORY3=4, SMOOTHQUICKSOURCE_FMSTOGGLE3POS=5, SMOOTHQUICKSOURCE_FMSTOGGLE5POS=6, SMOOTHQUICKSOURCE_FMSTOGGLE7POS=7 } SmoothQuickSourceOptions;
    // DisableSanityChecks
    ...
    // Constants
    static const quint32 OBJID = 0xE19AC6C2;
    ...
    float outerLoopKpSoftClamp() const;
    /*DEPRECATED*/ Q_INVOKABLE float getOuterLoopKpSoftClamp() const { return static_cast<float>(outerLoopKpSoftClamp()); }
    ...
    SystemIdentSettings_DestinationPidBank::Enum destinationPidBank() const;
    ...
    SystemIdentSettings_ThrustControl::Enum thrustControl() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getThrustControl() const { return static_cast<quint8>(thrustControl()); }
    SystemIdentSettings_SmoothQuickSource::Enum smoothQuickSource() const;
...
public slots:
    ...
    void setOuterLoopKpSoftClamp(const float value);
    ...
    void setDestinationPidBank(const SystemIdentSettings_DestinationPidBank::Enum value);
    /*DEPRECATED*/ void setDestinationPidBank(quint8 value) { setDestinationPidBank(static_cast<SystemIdentSettings_DestinationPidBank::Enum>(value)); }
    ...
    void setThrustControl(const SystemIdentSettings_ThrustControl::Enum value);
    /*DEPRECATED*/ void setThrustControl(quint8 value) { setThrustControl(static_cast<SystemIdentSettings_ThrustControl::Enum>(value)); }
    void setSmoothQuickSource(const SystemIdentSettings_SmoothQuickSource::Enum value);
    /*DEPRECATED*/ void setSmoothQuickSource(quint8 value) { setSmoothQuickSource(static_cast<SystemIdentSettings_SmoothQuickSource::Enum>(value)); }
...
signals:
    ...
    void outerLoopKpSoftClampChanged(const float value);
    /*DEPRECATED*/ void OuterLoopKpSoftClampChanged(float value);
    ...
    void destinationPidBankChanged(const SystemIdentSettings_DestinationPidBank::Enum value);
    ...
    void thrustControlChanged(const SystemIdentSettings_ThrustControl::Enum value);
    /*DEPRECATED*/ void ThrustControlChanged(quint8 value);
    void smoothQuickSourceChanged(const SystemIdentSettings_SmoothQuickSource::Enum value);
