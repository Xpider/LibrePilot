...
TaskInfo::TaskInfo(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    StackRemainingElemNames << "System" << "CallbackScheduler0" << "CallbackScheduler1" << "CallbackScheduler2" << "CallbackScheduler3" << "Receiver" << "Stabilization" << "Actuator" << "Sensors" << "Attitude" << "Altitude" << "Airspeed" << "MagBaro" << "FlightPlan" << "TelemetryTx" << "TelemetryRx" << "RadioTx" << "RadioRx" << "Com2UsbBridge" << "Usb2ComBridge" << "GPS" << "OSDGen" << "UAVOHoTTBridge" << "UAVOMSPBridge" << "UAVOFrskySensorHubBridge" << "UAVOMAVLinkBridge" << "AutoTune";
...
void TaskInfo::emitNotifications()
{
    ...
    emit stackRemainingUAVOHoTTBridgeChanged(stackRemainingUAVOHoTTBridge());
    /*DEPRECATED*/ emit StackRemaining_UAVOHoTTBridgeChanged(getStackRemaining_UAVOHoTTBridge());
    ...
    emit stackRemainingUAVOFrskySensorHubBridgeChanged(stackRemainingUAVOFrskySensorHubBridge());
    /*DEPRECATED*/ emit StackRemaining_UAVOFrskySensorHubBridgeChanged(getStackRemaining_UAVOFrskySensorHubBridge());
    ...
    emit runningUAVOHoTTBridgeChanged(runningUAVOHoTTBridge());
    /*DEPRECATED*/ emit Running_UAVOHoTTBridgeChanged(getRunning_UAVOHoTTBridge());
    ...
    emit runningUAVOFrskySensorHubBridgeChanged(runningUAVOFrskySensorHubBridge());
    /*DEPRECATED*/ emit Running_UAVOFrskySensorHubBridgeChanged(getRunning_UAVOFrskySensorHubBridge());
    ...
    emit runningTimeUAVOHoTTBridgeChanged(runningTimeUAVOHoTTBridge());
    /*DEPRECATED*/ emit RunningTime_UAVOHoTTBridgeChanged(getRunningTime_UAVOHoTTBridge());
    ...
    emit runningTimeUAVOFrskySensorHubBridgeChanged(runningTimeUAVOFrskySensorHubBridge());
    /*DEPRECATED*/ emit RunningTime_UAVOFrskySensorHubBridgeChanged(getRunningTime_UAVOFrskySensorHubBridge());
...
quint16 TaskInfo::stackRemainingUAVOHoTTBridge() const { return stackRemaining(22); }
void TaskInfo::setStackRemainingUAVOHoTTBridge(const quint16 value) { setStackRemaining(22, value); }
quint16 TaskInfo::stackRemainingUAVOMSPBridge() const { return stackRemaining(23); }
void TaskInfo::setStackRemainingUAVOMSPBridge(const quint16 value) { setStackRemaining(23, value); }
quint16 TaskInfo::stackRemainingUAVOFrskySensorHubBridge() const { return stackRemaining(24); }
void TaskInfo::setStackRemainingUAVOFrskySensorHubBridge(const quint16 value) { setStackRemaining(24, value); }
quint16 TaskInfo::stackRemainingUAVOMAVLinkBridge() const { return stackRemaining(25); }
void TaskInfo::setStackRemainingUAVOMAVLinkBridge(const quint16 value) { setStackRemaining(25, value); }
quint16 TaskInfo::stackRemainingAutoTune() const { return stackRemaining(26); }
void TaskInfo::setStackRemainingAutoTune(const quint16 value) { setStackRemaining(26, value); }
...
TaskInfo_Running::Enum TaskInfo::runningUAVOHoTTBridge() const { return running(22); }
void TaskInfo::setRunningUAVOHoTTBridge(const TaskInfo_Running::Enum value) { setRunning(22, value); }
TaskInfo_Running::Enum TaskInfo::runningUAVOMSPBridge() const { return running(23); }
void TaskInfo::setRunningUAVOMSPBridge(const TaskInfo_Running::Enum value) { setRunning(23, value); }
TaskInfo_Running::Enum TaskInfo::runningUAVOFrskySensorHubBridge() const { return running(24); }
void TaskInfo::setRunningUAVOFrskySensorHubBridge(const TaskInfo_Running::Enum value) { setRunning(24, value); }
TaskInfo_Running::Enum TaskInfo::runningUAVOMAVLinkBridge() const { return running(25); }
void TaskInfo::setRunningUAVOMAVLinkBridge(const TaskInfo_Running::Enum value) { setRunning(25, value); }
TaskInfo_Running::Enum TaskInfo::runningAutoTune() const { return running(26); }
void TaskInfo::setRunningAutoTune(const TaskInfo_Running::Enum value) { setRunning(26, value); }
...
quint16 TaskInfo::runningTimeUAVOHoTTBridge() const { return runningTime(22); }
void TaskInfo::setRunningTimeUAVOHoTTBridge(const quint16 value) { setRunningTime(22, value); }
quint16 TaskInfo::runningTimeUAVOMSPBridge() const { return runningTime(23); }
void TaskInfo::setRunningTimeUAVOMSPBridge(const quint16 value) { setRunningTime(23, value); }
quint16 TaskInfo::runningTimeUAVOFrskySensorHubBridge() const { return runningTime(24); }
void TaskInfo::setRunningTimeUAVOFrskySensorHubBridge(const quint16 value) { setRunningTime(24, value); }
quint16 TaskInfo::runningTimeUAVOMAVLinkBridge() const { return runningTime(25); }
void TaskInfo::setRunningTimeUAVOMAVLinkBridge(const quint16 value) { setRunningTime(25, value); }
quint16 TaskInfo::runningTimeAutoTune() const { return runningTime(26); }
void TaskInfo::setRunningTimeAutoTune(const quint16 value) { setRunningTime(26, value); }
