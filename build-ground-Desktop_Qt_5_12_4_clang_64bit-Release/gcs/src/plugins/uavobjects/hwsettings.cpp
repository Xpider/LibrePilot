...
HwSettings::HwSettings(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    CC_MainPortEnumOptions << "Disabled" << "Telemetry" << "GPS" << "S.Bus" << "DSM" << "DebugConsole" << "ComBridge" << "OsdHk" << "MSP" << "MAVLink" << "FrskySensorHub";
    ...
    RM_RcvrPortEnumOptions << "Disabled" << "PWM" << "PPM" << "PPM+PWM" << "PPM+Outputs" << "PPM+Telemetry" << "PPM+DebugConsole" << "PPM+ComBridge" << "PPM+MSP" << "PPM+MAVLink" << "PPM+GPS" << "PPM+HoTT Telemetry" << "Outputs" << "Telemetry" << "DebugConsole" << "ComBridge" << "MSP" << "MAVLink" << "GPS" << "HoTT Telemetry" << "IBus" << "FrskySensorHub";
    fields.append(new UAVObjectField("RM_RcvrPort", tr(""), "function", UAVObjectField::ENUM, RM_RcvrPortElemNames, RM_RcvrPortEnumOptions, "%0905NE:PPM+PWM:PPM+Telemetry:PPM+DebugConsole:PPM+ComBridge:PPM+MSP:PPM+MAVLink:PPM+GPS:PPM+HoTT Telemetry:Telemetry:DebugConsole:ComBridge:MSP:MAVLink:GPS:HoTT Telemetry:IBus;"));
    // RM_MainPort
    QStringList RM_MainPortElemNames;
    RM_MainPortElemNames << "0";
    QStringList RM_MainPortEnumOptions;
    RM_MainPortEnumOptions << "Disabled" << "Telemetry" << "GPS" << "S.Bus" << "DSM" << "HoTT Telemetry" << "DebugConsole" << "ComBridge" << "OsdHk" << "MSP" << "MAVLink" << "FrskySensorHub";
    ...
    RM_FlexiPortEnumOptions << "Disabled" << "Telemetry" << "GPS" << "I2C" << "DSM" << "EX.Bus" << "HoTT SUMD" << "HoTT SUMH" << "HoTT Telemetry" << "SRXL" << "IBus" << "DebugConsole" << "ComBridge" << "OsdHk" << "MSP" << "MAVLink" << "FrskySensorHub";
    ...
    SPK2_MainPortEnumOptions << "Disabled" << "Telemetry" << "GPS" << "DSM" << "DebugConsole" << "ComBridge" << "OsdHk" << "MSP" << "MAVLink" << "FrskySensorHub";
    ...
    SPK2_FlexiPortEnumOptions << "Disabled" << "Telemetry" << "GPS" << "I2C" << "DSM" << "EX.Bus" << "HoTT SUMD" << "HoTT SUMH" << "SRXL" << "IBus" << "DebugConsole" << "ComBridge" << "OsdHk" << "MSP" << "MAVLink" << "FrskySensorHub";
    ...
    USB_VCPPortEnumOptions << "USBTelemetry" << "ComBridge" << "DebugConsole" << "Disabled" << "MAVLink";
    ...
    RadioAuxStreamEnumOptions << "DebugConsole" << "Disabled" << "MAVLink" << "ComBridge";
    fields.append(new UAVObjectField("RadioAuxStream", tr(""), "function", UAVObjectField::ENUM, RadioAuxStreamElemNames, RadioAuxStreamEnumOptions, ""));
    // OptionalModules
    ...
    // SBusMode
    QStringList SBusModeElemNames;
    SBusModeElemNames << "0";
    QStringList SBusModeEnumOptions;
    SBusModeEnumOptions << "Normal" << "Non Inverted";
    fields.append(new UAVObjectField("SBusMode", tr(""), "", UAVObjectField::ENUM, SBusModeElemNames, SBusModeEnumOptions, ""));
    // WS2811LED_Out
...
void HwSettings::emitNotifications()
{
    ...
    emit sBusModeChanged(sBusMode());
    /*DEPRECATED*/ emit SBusModeChanged(getSBusMode());
...
void HwSettings::registerQMLTypes() {
    ...
    qmlRegisterType<HwSettings_RadioAuxStream>("UAVTalk.HwSettings", 1, 0, "RadioAuxStream");
    ...
    qmlRegisterType<HwSettings_SBusMode>("UAVTalk.HwSettings", 1, 0, "SBusMode");
...
HwSettings_RadioAuxStream::Enum HwSettings::radioAuxStream() const
{
   QMutexLocker locker(mutex);
   return static_cast<HwSettings_RadioAuxStream::Enum>(data_.RadioAuxStream);
}
void HwSettings::setRadioAuxStream(const HwSettings_RadioAuxStream::Enum value)
{
   mutex->lock();
...
HwSettings_SBusMode::Enum HwSettings::sBusMode() const
{
   QMutexLocker locker(mutex);
   return static_cast<HwSettings_SBusMode::Enum>(data_.SBusMode);
}
void HwSettings::setSBusMode(const HwSettings_SBusMode::Enum value)
{
   mutex->lock();
   bool changed = (data_.SBusMode != static_cast<quint8>(value));
   data_.SBusMode = static_cast<quint8>(value);
   mutex->unlock();
   if (changed) { emit sBusModeChanged(value); emit SBusModeChanged(static_cast<quint8>(value)); }
}
