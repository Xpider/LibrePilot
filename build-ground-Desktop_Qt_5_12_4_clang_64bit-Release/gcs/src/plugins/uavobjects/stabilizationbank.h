...
{
    Q_OBJECT
    Q_PROPERTY(float attitudeFeedForwardRoll READ attitudeFeedForwardRoll WRITE setAttitudeFeedForwardRoll NOTIFY attitudeFeedForwardRollChanged)
    Q_PROPERTY(float attitudeFeedForwardPitch READ attitudeFeedForwardPitch WRITE setAttitudeFeedForwardPitch NOTIFY attitudeFeedForwardPitchChanged)
    Q_PROPERTY(float attitudeFeedForwardYaw READ attitudeFeedForwardYaw WRITE setAttitudeFeedForwardYaw NOTIFY attitudeFeedForwardYawChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(float AttitudeFeedForward_Roll READ getAttitudeFeedForward_Roll WRITE setAttitudeFeedForward_Roll NOTIFY AttitudeFeedForward_RollChanged);
    /*DEPRECATED*/ Q_PROPERTY(float AttitudeFeedForward_Pitch READ getAttitudeFeedForward_Pitch WRITE setAttitudeFeedForward_Pitch NOTIFY AttitudeFeedForward_PitchChanged);
    /*DEPRECATED*/ Q_PROPERTY(float AttitudeFeedForward_Yaw READ getAttitudeFeedForward_Yaw WRITE setAttitudeFeedForward_Yaw NOTIFY AttitudeFeedForward_YawChanged);
...
public:
    ...
    // Field information
    // AttitudeFeedForward
    typedef enum { ATTITUDEFEEDFORWARD_ROLL=0, ATTITUDEFEEDFORWARD_PITCH=1, ATTITUDEFEEDFORWARD_YAW=2 } AttitudeFeedForwardElem;
    static const quint32 ATTITUDEFEEDFORWARD_NUMELEM = 3;
    // RollRatePID
    ...
    // Constants
    static const quint32 OBJID = 0x129DACA0;
    ...
    Q_INVOKABLE float attitudeFeedForward(quint32 index) const;
    /*DEPRECATED*/ Q_INVOKABLE float getAttitudeFeedForward(quint32 index) const { return static_cast<float>(attitudeFeedForward(index)); }
    float attitudeFeedForwardRoll() const;
    /*DEPRECATED*/ Q_INVOKABLE float getAttitudeFeedForward_Roll() const { return static_cast<float>(attitudeFeedForwardRoll()); }
    float attitudeFeedForwardPitch() const;
    /*DEPRECATED*/ Q_INVOKABLE float getAttitudeFeedForward_Pitch() const { return static_cast<float>(attitudeFeedForwardPitch()); }
    float attitudeFeedForwardYaw() const;
    /*DEPRECATED*/ Q_INVOKABLE float getAttitudeFeedForward_Yaw() const { return static_cast<float>(attitudeFeedForwardYaw()); }
...
public slots:
    Q_INVOKABLE void setAttitudeFeedForward(quint32 index, const float value);
    void setAttitudeFeedForwardRoll(const float value);
    /*DEPRECATED*/ void setAttitudeFeedForward_Roll(float value) { setAttitudeFeedForwardRoll(static_cast<float>(value)); }
    void setAttitudeFeedForwardPitch(const float value);
    /*DEPRECATED*/ void setAttitudeFeedForward_Pitch(float value) { setAttitudeFeedForwardPitch(static_cast<float>(value)); }
    void setAttitudeFeedForwardYaw(const float value);
    /*DEPRECATED*/ void setAttitudeFeedForward_Yaw(float value) { setAttitudeFeedForwardYaw(static_cast<float>(value)); }
...
signals:
    void attitudeFeedForwardChanged(quint32 index, const float value);
    /*DEPRECATED*/ void AttitudeFeedForwardChanged(quint32 index, float value);
    void attitudeFeedForwardRollChanged(const float value);
    /*DEPRECATED*/ void AttitudeFeedForward_RollChanged(float value);
    void attitudeFeedForwardPitchChanged(const float value);
    /*DEPRECATED*/ void AttitudeFeedForward_PitchChanged(float value);
    void attitudeFeedForwardYawChanged(const float value);
    /*DEPRECATED*/ void AttitudeFeedForward_YawChanged(float value);
