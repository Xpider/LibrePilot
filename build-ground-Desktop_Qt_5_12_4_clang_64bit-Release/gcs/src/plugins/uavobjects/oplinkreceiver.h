...
class UAVOBJECTS_EXPORT OPLinkReceiver: public UAVDataObject
{
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint8 LinkQuality READ getLinkQuality WRITE setLinkQuality NOTIFY LinkQualityChanged);
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0x3A4DC72C;
    ...
    /*DEPRECATED*/ Q_INVOKABLE quint8 getLinkQuality() const { return static_cast<quint8>(linkQuality()); }
...
public slots:
    ...
    /*DEPRECATED*/ void setLinkQuality(quint8 value) { setLinkQuality(static_cast<quint16>(value)); }
...
signals:
    ...
    /*DEPRECATED*/ void LinkQualityChanged(quint8 value);
