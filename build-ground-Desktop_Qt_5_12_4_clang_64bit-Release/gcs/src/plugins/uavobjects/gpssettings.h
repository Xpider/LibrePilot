...
class GPSSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { DataProtocolCount = 3, UbxAutoConfigCount = 5, UbxDynamicModelCount = 8, UbxSBASModeCount = 8, UbxSBASSatsCount = 6, UbxGNSSModeCount = 8, UbxAssistNowAutonomousCount = 2,  };
...
class GPSSettings_UbxGNSSMode : public QObject {
    Q_OBJECT
public:
    enum Enum { Default, GPS, GLONASS, GPSGLONASS, GPSBeiDou, GLONASSBeiDou, GPSGALILEO, GPSGLONASSGALILEO };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
public:
    ...
    // UbxGNSSMode
    typedef enum { UBXGNSSMODE_DEFAULT=0, UBXGNSSMODE_GPS=1, UBXGNSSMODE_GLONASS=2, UBXGNSSMODE_GPSGLONASS=3, UBXGNSSMODE_GPSBEIDOU=4, UBXGNSSMODE_GLONASSBEIDOU=5, UBXGNSSMODE_GPSGALILEO=6, UBXGNSSMODE_GPSGLONASSGALILEO=7 } UbxGNSSModeOptions;
    ...
    // Constants
    static const quint32 OBJID = 0xF300A164;
