...
void UAVObjectsInitialize(UAVObjectManager *objMngr)
{
    ...
    HoTTBridgeSettings::registerQMLTypes();
    objMngr->registerObject( new HoTTBridgeStatus() );
    HoTTBridgeStatus::registerQMLTypes();
    objMngr->registerObject( new HwDiscoveryF4BareSettings() );
    HwDiscoveryF4BareSettings::registerQMLTypes();
    objMngr->registerObject( new HwPikoBLXSettings() );
    HwPikoBLXSettings::registerQMLTypes();
    objMngr->registerObject( new HwSettings() );
    HwSettings::registerQMLTypes();
    objMngr->registerObject( new HwSPRacingF3EVOSettings() );
    HwSPRacingF3EVOSettings::registerQMLTypes();
    objMngr->registerObject( new HwSPRacingF3Settings() );
    HwSPRacingF3Settings::registerQMLTypes();
    objMngr->registerObject( new HwTinyFISHSettings() );
    HwTinyFISHSettings::registerQMLTypes();
