...
class UAVOBJECTS_EXPORT AttitudeState: public UAVDataObject
{
    ...
    /*DEPRECATED*/ Q_PROPERTY(float NavYaw READ getNavYaw WRITE setNavYaw NOTIFY NavYawChanged);
...
public:
    ...
    float navYaw() const;
    /*DEPRECATED*/ Q_INVOKABLE float getNavYaw() const { return static_cast<float>(navYaw()); }
...
signals:
    ...
    /*DEPRECATED*/ void NavYawChanged(float value);
