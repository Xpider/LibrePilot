...
class UAVOBJECTS_EXPORT OPLinkStatus: public UAVDataObject
{
    ...
    Q_PROPERTY(qint32 afcCorrection READ afcCorrection WRITE setAFCCorrection NOTIFY afcCorrectionChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(qint32 AFCCorrection READ getAFCCorrection WRITE setAFCCorrection NOTIFY AFCCorrectionChanged);
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0xC4A03B86;
    ...
    qint32 afcCorrection() const;
    /*DEPRECATED*/ Q_INVOKABLE qint32 getAFCCorrection() const { return static_cast<qint32>(afcCorrection()); }
...
public slots:
    ...
    void setAFCCorrection(const qint32 value);
...
signals:
    ...
    void afcCorrectionChanged(const qint32 value);
    /*DEPRECATED*/ void AFCCorrectionChanged(qint32 value);
