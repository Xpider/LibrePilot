...
FlightBatterySettings::FlightBatterySettings(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    CellVoltageThresholdsElemNames << "Warning" << "Critical";
    ...
    TypeEnumOptions << "LiPo" << "LiHV" << "A123" << "LiCo" << "LiFeSO4" << "None";
...
void FlightBatterySettings::emitNotifications()
{
    ...
    emit cellVoltageThresholdsCriticalChanged(cellVoltageThresholdsCritical());
    /*DEPRECATED*/ emit CellVoltageThresholds_CriticalChanged(getCellVoltageThresholds_Critical());
...
float FlightBatterySettings::cellVoltageThresholdsCritical() const { return cellVoltageThresholds(1); }
void FlightBatterySettings::setCellVoltageThresholdsCritical(const float value) { setCellVoltageThresholds(1, value); }
