...
float StabilizationSettingsBank1::attitudeFeedForward(quint32 index) const
{
   QMutexLocker locker(mutex);
   return static_cast<float>(data_.AttitudeFeedForward[index]);
}
void StabilizationSettingsBank1::setAttitudeFeedForward(quint32 index, const float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::attitudeFeedForwardRoll() const { return attitudeFeedForward(0); }
void StabilizationSettingsBank1::setAttitudeFeedForwardRoll(const float value) { setAttitudeFeedForward(0, value); }
float StabilizationSettingsBank1::attitudeFeedForwardPitch() const { return attitudeFeedForward(1); }
void StabilizationSettingsBank1::setAttitudeFeedForwardPitch(const float value) { setAttitudeFeedForward(1, value); }
float StabilizationSettingsBank1::attitudeFeedForwardYaw() const { return attitudeFeedForward(2); }
void StabilizationSettingsBank1::setAttitudeFeedForwardYaw(const float value) { setAttitudeFeedForward(2, value); }
