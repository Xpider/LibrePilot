...
class HwSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { CCRcvrPortCount = 7, CCMainPortCount = 11, CCFlexiPortCount = 16, RVRcvrPortCount = 5, RVAuxPortCount = 8, RVAuxSBusPortCount = 8, RVFlexiPortCount = 7, RVTelemetryPortCount = 6, RVGPSPortCount = 7, RMRcvrPortCount = 22, RMMainPortCount = 12, RMFlexiPortCount = 17, SPK2RcvrPortCount = 9, SPK2MainPortCount = 10, SPK2FlexiPortCount = 16, SPK2I2CPortCount = 2, TelemetrySpeedCount = 7, GPSSpeedCount = 8, DebugConsoleSpeedCount = 7, MSPSpeedCount = 7, MAVLinkSpeedCount = 7, USBHIDPortCount = 3, USBVCPPortCount = 5, RadioAuxStreamCount = 4, OptionalModulesCount = 2, ADCRoutingCount = 5, SBusModeCount = 2, WS2811LEDOutCount = 9,  };
...
class HwSettings_CCMainPort : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, Telemetry, GPS, SBus, DSM, DebugConsole, ComBridge, OsdHk, MSP, MAVLink, FrskySensorHub };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class HwSettings_RMRcvrPort : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, PWM, PPM, PPMPWM, PPMOutputs, PPMTelemetry, PPMDebugConsole, PPMComBridge, PPMMSP, PPMMAVLink, PPMGPS, PPMHoTTTelemetry, Outputs, Telemetry, DebugConsole, ComBridge, MSP, MAVLink, GPS, HoTTTelemetry, IBus, FrskySensorHub };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class HwSettings_RMMainPort : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, Telemetry, GPS, SBus, DSM, HoTTTelemetry, DebugConsole, ComBridge, OsdHk, MSP, MAVLink, FrskySensorHub };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class HwSettings_RMFlexiPort : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, Telemetry, GPS, I2C, DSM, EXBus, HoTTSUMD, HoTTSUMH, HoTTTelemetry, SRXL, IBus, DebugConsole, ComBridge, OsdHk, MSP, MAVLink, FrskySensorHub };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class HwSettings_SPK2MainPort : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, Telemetry, GPS, DSM, DebugConsole, ComBridge, OsdHk, MSP, MAVLink, FrskySensorHub };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class HwSettings_SPK2FlexiPort : public QObject {
    Q_OBJECT
public:
    enum Enum { Disabled, Telemetry, GPS, I2C, DSM, EXBus, HoTTSUMD, HoTTSUMH, SRXL, IBus, DebugConsole, ComBridge, OsdHk, MSP, MAVLink, FrskySensorHub };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class HwSettings_USBVCPPort : public QObject {
    Q_OBJECT
public:
    enum Enum { USBTelemetry, ComBridge, DebugConsole, Disabled, MAVLink };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};

class HwSettings_RadioAuxStream : public QObject {
    Q_OBJECT
public:
    enum Enum { DebugConsole, Disabled, MAVLink, ComBridge };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class HwSettings_SBusMode : public QObject {
    Q_OBJECT
public:
    enum Enum { Normal, NonInverted };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
class UAVOBJECTS_EXPORT HwSettings: public UAVDataObject
{
    ...
    Q_PROPERTY(HwSettings_RadioAuxStream::Enum radioAuxStream READ radioAuxStream WRITE setRadioAuxStream NOTIFY radioAuxStreamChanged)
    ...
    Q_PROPERTY(HwSettings_SBusMode::Enum sBusMode READ sBusMode WRITE setSBusMode NOTIFY sBusModeChanged)
    ...
    /*DEPRECATED*/ Q_PROPERTY(quint8 SBusMode READ getSBusMode WRITE setSBusMode NOTIFY SBusModeChanged);
...
public:
    ...
    // CC_MainPort
    typedef enum { CC_MAINPORT_DISABLED=0, CC_MAINPORT_TELEMETRY=1, CC_MAINPORT_GPS=2, CC_MAINPORT_SBUS=3, CC_MAINPORT_DSM=4, CC_MAINPORT_DEBUGCONSOLE=5, CC_MAINPORT_COMBRIDGE=6, CC_MAINPORT_OSDHK=7, CC_MAINPORT_MSP=8, CC_MAINPORT_MAVLINK=9, CC_MAINPORT_FRSKYSENSORHUB=10 } CC_MainPortOptions;
    // CC_FlexiPort
    ...
    // RM_RcvrPort
    typedef enum { RM_RCVRPORT_DISABLED=0, RM_RCVRPORT_PWM=1, RM_RCVRPORT_PPM=2, RM_RCVRPORT_PPMPWM=3, RM_RCVRPORT_PPMOUTPUTS=4, RM_RCVRPORT_PPMTELEMETRY=5, RM_RCVRPORT_PPMDEBUGCONSOLE=6, RM_RCVRPORT_PPMCOMBRIDGE=7, RM_RCVRPORT_PPMMSP=8, RM_RCVRPORT_PPMMAVLINK=9, RM_RCVRPORT_PPMGPS=10, RM_RCVRPORT_PPMHOTTTELEMETRY=11, RM_RCVRPORT_OUTPUTS=12, RM_RCVRPORT_TELEMETRY=13, RM_RCVRPORT_DEBUGCONSOLE=14, RM_RCVRPORT_COMBRIDGE=15, RM_RCVRPORT_MSP=16, RM_RCVRPORT_MAVLINK=17, RM_RCVRPORT_GPS=18, RM_RCVRPORT_HOTTTELEMETRY=19, RM_RCVRPORT_IBUS=20, RM_RCVRPORT_FRSKYSENSORHUB=21 } RM_RcvrPortOptions;
    // RM_MainPort
    typedef enum { RM_MAINPORT_DISABLED=0, RM_MAINPORT_TELEMETRY=1, RM_MAINPORT_GPS=2, RM_MAINPORT_SBUS=3, RM_MAINPORT_DSM=4, RM_MAINPORT_HOTTTELEMETRY=5, RM_MAINPORT_DEBUGCONSOLE=6, RM_MAINPORT_COMBRIDGE=7, RM_MAINPORT_OSDHK=8, RM_MAINPORT_MSP=9, RM_MAINPORT_MAVLINK=10, RM_MAINPORT_FRSKYSENSORHUB=11 } RM_MainPortOptions;
    // RM_FlexiPort
    typedef enum { RM_FLEXIPORT_DISABLED=0, RM_FLEXIPORT_TELEMETRY=1, RM_FLEXIPORT_GPS=2, RM_FLEXIPORT_I2C=3, RM_FLEXIPORT_DSM=4, RM_FLEXIPORT_EXBUS=5, RM_FLEXIPORT_HOTTSUMD=6, RM_FLEXIPORT_HOTTSUMH=7, RM_FLEXIPORT_HOTTTELEMETRY=8, RM_FLEXIPORT_SRXL=9, RM_FLEXIPORT_IBUS=10, RM_FLEXIPORT_DEBUGCONSOLE=11, RM_FLEXIPORT_COMBRIDGE=12, RM_FLEXIPORT_OSDHK=13, RM_FLEXIPORT_MSP=14, RM_FLEXIPORT_MAVLINK=15, RM_FLEXIPORT_FRSKYSENSORHUB=16 } RM_FlexiPortOptions;
    // SPK2_RcvrPort
    ...
    // SPK2_MainPort
    typedef enum { SPK2_MAINPORT_DISABLED=0, SPK2_MAINPORT_TELEMETRY=1, SPK2_MAINPORT_GPS=2, SPK2_MAINPORT_DSM=3, SPK2_MAINPORT_DEBUGCONSOLE=4, SPK2_MAINPORT_COMBRIDGE=5, SPK2_MAINPORT_OSDHK=6, SPK2_MAINPORT_MSP=7, SPK2_MAINPORT_MAVLINK=8, SPK2_MAINPORT_FRSKYSENSORHUB=9 } SPK2_MainPortOptions;
    // SPK2_FlexiPort
    typedef enum { SPK2_FLEXIPORT_DISABLED=0, SPK2_FLEXIPORT_TELEMETRY=1, SPK2_FLEXIPORT_GPS=2, SPK2_FLEXIPORT_I2C=3, SPK2_FLEXIPORT_DSM=4, SPK2_FLEXIPORT_EXBUS=5, SPK2_FLEXIPORT_HOTTSUMD=6, SPK2_FLEXIPORT_HOTTSUMH=7, SPK2_FLEXIPORT_SRXL=8, SPK2_FLEXIPORT_IBUS=9, SPK2_FLEXIPORT_DEBUGCONSOLE=10, SPK2_FLEXIPORT_COMBRIDGE=11, SPK2_FLEXIPORT_OSDHK=12, SPK2_FLEXIPORT_MSP=13, SPK2_FLEXIPORT_MAVLINK=14, SPK2_FLEXIPORT_FRSKYSENSORHUB=15 } SPK2_FlexiPortOptions;
    // SPK2_I2CPort
    ...
    // USB_VCPPort
    typedef enum { USB_VCPPORT_USBTELEMETRY=0, USB_VCPPORT_COMBRIDGE=1, USB_VCPPORT_DEBUGCONSOLE=2, USB_VCPPORT_DISABLED=3, USB_VCPPORT_MAVLINK=4 } USB_VCPPortOptions;
    // RadioAuxStream
    typedef enum { RADIOAUXSTREAM_DEBUGCONSOLE=0, RADIOAUXSTREAM_DISABLED=1, RADIOAUXSTREAM_MAVLINK=2, RADIOAUXSTREAM_COMBRIDGE=3 } RadioAuxStreamOptions;
    // OptionalModules
    ...
    // DSMxBind
    // SBusMode
    typedef enum { SBUSMODE_NORMAL=0, SBUSMODE_NONINVERTED=1 } SBusModeOptions;
    // WS2811LED_Out
    ...
    // Constants
    static const quint32 OBJID = 0xA1C2C566;
    ...
    HwSettings_RadioAuxStream::Enum radioAuxStream() const;
    ...
    HwSettings_SBusMode::Enum sBusMode() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getSBusMode() const { return static_cast<quint8>(sBusMode()); }
...
public slots:
    ...
    void setRadioAuxStream(const HwSettings_RadioAuxStream::Enum value);
    /*DEPRECATED*/ void setRadioAuxStream(quint8 value) { setRadioAuxStream(static_cast<HwSettings_RadioAuxStream::Enum>(value)); }
    ...
    void setSBusMode(const HwSettings_SBusMode::Enum value);
    /*DEPRECATED*/ void setSBusMode(quint8 value) { setSBusMode(static_cast<HwSettings_SBusMode::Enum>(value)); }
...
signals:
    ...
    void radioAuxStreamChanged(const HwSettings_RadioAuxStream::Enum value);
    ...
    void sBusModeChanged(const HwSettings_SBusMode::Enum value);
    /*DEPRECATED*/ void SBusModeChanged(quint8 value);
