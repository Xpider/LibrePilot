...
class RevoSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { FusionAlgorithmCount = 9,  };
...
class RevoSettings_FusionAlgorithm : public QObject {
    Q_OBJECT
public:
    enum Enum { None, BasicComplementary, ComplementaryMag, ComplementaryMagGPSOutdoor, INS13Indoor, GPSNavigationINS13, GPSNavigationINS13CF, TestingINSIndoorCF, AcroNoSensors };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
public:
    ...
    // FusionAlgorithm
    typedef enum { FUSIONALGORITHM_NONE=0, FUSIONALGORITHM_BASICCOMPLEMENTARY=1, FUSIONALGORITHM_COMPLEMENTARYMAG=2, FUSIONALGORITHM_COMPLEMENTARYMAGGPSOUTDOOR=3, FUSIONALGORITHM_INS13INDOOR=4, FUSIONALGORITHM_GPSNAVIGATIONINS13=5, FUSIONALGORITHM_GPSNAVIGATIONINS13CF=6, FUSIONALGORITHM_TESTINGINSINDOORCF=7, FUSIONALGORITHM_ACRONOSENSORS=8 } FusionAlgorithmOptions;


    // Constants
    static const quint32 OBJID = 0xC41DB204;
