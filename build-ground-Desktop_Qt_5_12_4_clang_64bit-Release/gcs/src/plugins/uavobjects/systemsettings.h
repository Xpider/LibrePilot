...
class SystemSettingsConstants : public QObject {
    Q_OBJECT
public:
    enum Enum { AirframeTypeCount = 23, ThrustControlCount = 3,  };
...
class SystemSettings_AirframeType : public QObject {
    Q_OBJECT
public:
    enum Enum { FixedWing, FixedWingElevon, FixedWingVtail, VTOL, HeliCP, QuadX, QuadP, Hexa, Octo, Custom, HexaX, HexaH, OctoV, OctoCoaxP, OctoCoaxX, OctoX, HexaCoax, Tri, GroundVehicleCar, GroundVehicleDifferential, GroundVehicleMotorcycle, GroundVehicleBoat, GroundVehicleDifferentialBoat };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
};
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0x74AB3A70;
